...
{{-- navegación derecha --}}
    <div class="row col-sm-6 header-container" style=" padding: 0; float: right; ">
        <nav class="menu navbar navbar-expand-lg navbar-linght bg-dark navigation-bar-style" style="height: 50px; width: 200px;">
            <div class="navbar-brand " style="height: 29px; width: 115px; background-color: white">
                <img class="img-fluid img-height" style="height: 25px; width: 110px; " src="{{ asset('storage/logo/logoBeba.png')}}" alt="">
            </div>
            <!-- Left Side Of Navbar -->
            <div class=" row  col-sm-6" style="justify-content: space-evenly; ">
    ...
    <div class="col-sm-6 header-container" style="margin: 0; padding: 0; float: right; ">
        <nav class="menu navbar navbar-expand-lg navbar-linght bg-dark navigation-bar-style" style="height: 45px; width: 164px; margin-left: 0; position: inherit">
